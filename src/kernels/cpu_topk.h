...
static inline __attribute__((always_inline)) size_t cpu_topk_pick_next(const float * restrict scores,
                                        size_t num_scores,
...
static inline __attribute__((always_inline)) void cpu_topk_desc(const float * restrict scores,

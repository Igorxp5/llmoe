...
static inline __attribute__((always_inline)) float cpu_matmul_dot_bf16(const float * restrict a_row,
...
static inline __attribute__((always_inline)) void cpu_matmul_bf16(float * restrict output,
